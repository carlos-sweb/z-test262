...
Total: 47381 tests | corridos: 45639 | **PASS: 18802 (41.2% de los corridos)** | FAIL: 26159 | CRASH: 0 | TIMEOUT: 678 | SKIP (by design): 1742
...
| test/built-ins/DataView | 203 | 358 | 0 | 0 | 0 | 36.2% |
...
| test/built-ins/Object | 1578 | 1806 | 0 | 16 | 11 | 46.4% |
...
| test/language/expressions | 6055 | 4372 | 0 | 87 | 588 | 57.6% |
...
- **2552x** `z-run: NotImplemented: the script uses a feature this engine doesn't support yet`
...
- **1059x** `z-run: NotImplemented: the script uses a feature this engine doesn't support yet
...
- **438x** `Uncaught TypeError: Cannot read properties of undefined (reading '…')`
...
- **295x** `Uncaught ReferenceError: $N is not defined`
  - ej: `test/language/eval-code/indirect/realm.js`
- **240x** `Uncaught TypeError: Cannot convert undefined or null to object`
...
- **136x** `Uncaught ReferenceError: SharedArrayBuffer is not defined`
  - ej: `test/language/expressions/class/subclass-builtins/subclass-SharedArrayBuffer.js`
- **129x** `Uncaught ReferenceError: UintNArray is not defined`
  - ej: `test/language/expressions/class/subclass-builtins/subclass-Uint16Array.js`
- **126x** `Uncaught ReferenceError: IntNArray is not defined`
  - ej: `test/language/expressions/class/subclass-builtins/subclass-Int16Array.js`
