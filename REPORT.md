...
| test/built-ins/Array | 879 | 2143 | 0 | 23 | 36 | 28.9% |
...
| test/built-ins/String | 640 | 580 | 0 | 0 | 3 | 52.5% |
...
- **2202x** `z-run: NotImplemented: the script uses a feature this engine doesn't support yet`
